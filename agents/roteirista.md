...
2. **Entender a SEQUÊNCIA de princípios** — ex: "Conflito Universal → Contraste → Debate Mental → Aha → Moral"
3. **Identificar QUAL EMOÇÃO cada frase provoca** — raiva, curiosidade, identificação, surpresa
4. **Escrever texto TOTALMENTE NOVO** que provoca a MESMA sequência de emoções usando os MESMOS princípios
